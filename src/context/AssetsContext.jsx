    ...
    useEffect(() => {
        ...
        const unsubscribe = onValue(categoriesRef, (snapshot) => {
            ...
            if (data) {
                ...
                // Initialize if empty, as per user requirement to have energy/water by default
                // We do this ONCE to avoid loop, but since it's missing, it's safe.
                console.log("Initializing categories...");
                const defaultCats = ['energy', 'water'];
